                            ...
                            <v-row>
                                <v-col cols="12" md="6">
                                    <v-textarea
                                        class="font-weight-medium"
                                        outlined
                                        v-model="historia.notas"
                                        label="Otros - no lista"

                                    ></v-textarea>
                                </v-col>
                                <v-col cols="12" md="1">
                                    <v-text-field
                                        v-if="isSupervisor || userName==historia.usename"
                                        v-model="historia.username"
                                        label="Usuario"
                                        readonly
                                    >
                                    </v-text-field>
            ...
            submit() {
                ...
                if (this.loading === false){
                    ...
                    this.$validator.validateAll().then((result) => {
                        if (result){
                             axios.put(this.url+"/"+this.historia.id, this.historia)
                                .then(res => {
