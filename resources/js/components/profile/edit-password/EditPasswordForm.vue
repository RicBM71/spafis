                ...
                <v-row>
                    <v-col cols="12" md="4">
                        ...
                        <v-text-field
                            ...
                            v-validate="'required|min:2|confirmed:new_password'"
                            :append-icon="show ? 'mdi-eye' : 'mdi-eye-off'"
                            :type="show ? 'text' : 'password'"
                    ...
                    <v-col v-if="avatar !='#'">
                        ...
                        <v-btn @click="openDialog" text rounded><v-icon color="red darken-4">mdi-delete</v-icon> Eliminar Avatar</v-btn>
                    </v-col>
                    <v-col cols="2" v-else>
                        <vue-dropzone
                            ref="myVueDropzone"
 ...
 import {mapGetters} from 'vuex';
	export default {
        ...
        mounted(){
            ...
            this.avatar = this.userAvatar == null ? '#' : this.userAvatar;
