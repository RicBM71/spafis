...
class CreateEmpresasTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('empresas', function (Blueprint $table) {
            ...
            $table->Integer('ult_bono')->default(0);
            $table->string('sms_usr', 30)->nullable();
            $table->string('sms_password', 30)->nullable();
            $table->string('sms_licencia', 30)->nullable();
            $table->string('sms_sender', 30)->nullable();
            $table->string('sms_pais', 3)->nullable();
            $table->string('sms_zona', 30)->nullable();
            $table->time('sms_am')->nullable();
